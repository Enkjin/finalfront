...
export default function Home() {
  ...
  const [comprise,comprisecheck] = useState(true)
      ...
      <main className={styles.main}>
        ...
        <div className={styles.header}>
          ...
          <div className={styles.usercontent}>
            {menu.map((item,index)=>{
              return(<Button onPress={clickButton} name={item} auto color="secondary" rounded flat  key={index}>{item}</Button>)
            })}
          </div>
       ...
       {incomeCheck&& 
        <div className={styles.iwcontainer}>
          <div> <Incomes/></div>
          <div> <WidthDraw/></div>
